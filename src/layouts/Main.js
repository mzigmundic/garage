            ...
            <Switch>
                ...
                <Route
                    ...
                    render={(props) => {
                        ...
                        if (vehicleData) {
                            return <EditVehicle vehicleData={vehicleData} brands={brands} submitVehicleData={submitVehicleData} />;
                        }
                    }}
                />
                ...
                <Route
                    ...
                    render={(props) => {
                        ...
                        if (brandData) {
                            return <EditBrand brandData={brandData} submitBrandData={submitBrandData} />;
                        }
                    }}
                />
